...
const EmployeeForm = ({ onSubmit, isLoading, initialData }: EmployeeFormProps) => {
  ...
  const handleFormSubmit = (data: EmployeeFormData) => {
    ...
    const payload: EmployeeInsert = {
      ...
      uan_number: rest.uan_number,
      work_location: rest.work_location,
      company: rest.company,
      bank_name: rest.bank_name,
      bank_account_no: rest.bank_account_no,
      ifsc_code: rest.ifsc_code,
      branch_name: rest.branch_name,
      pf_number: rest.pf_number,
      esic_number: rest.esic_number,
      basic_salary: rest.basic_salary,
      hra: rest.hra,
      other_allowances: rest.other_allowances,
      pf_deduction: rest.pf_deduction,
      esi_deduction: rest.esi_deduction,
      professional_tax: rest.professional_tax,
      other_deductions: rest.other_deductions,
    };
